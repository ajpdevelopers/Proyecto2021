...
{
    public partial class FormPrincipalD : Form
    {
        public FormPrincipalD()
        {
            InitializeComponent();
        ...
        {
            AbrirFormularios<FormConsultasD>();
        ...
        private void lblNombreIzq_Click(object sender, EventArgs e)
        {
